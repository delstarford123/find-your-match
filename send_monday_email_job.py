"""
send_monday_email_job.py
========================
Standalone cron script for Monday 08:00 EAT weekly match emails.

Add this in cPanel Cron Jobs:
  Minute: 0
  Hour:   5          (05:00 UTC = 08:00 EAT)
  Day:    *
  Month:  *
  Weekday: 1         (1 = Monday)

  Command:
  /home/YOURUSERNAME/mmust-dating-ai/.venv/bin/python /home/YOURUSERNAME/mmust-dating-ai/send_monday_email_job.py >> /home/YOURUSERNAME/logs/monday_email.log 2>&1
"""
...
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s [MONDAY-JOB] %(levelname)s: %(message)s"
)
...
logger.info("=" * 55)
logger.info("Monday Love Sheet Job Started")
